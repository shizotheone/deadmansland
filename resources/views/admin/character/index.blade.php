...
@section('content')
        <div class="row">
            <div class="col">
            <h5 class="white-text panel-space">Charakterliste</h5>
            </div>
            <div class="col">
            ...
            <div class="col s12">
                <ul class="collection">
                    ...
                    <li class="collection-item">
                        <div>
                            <b>{{ $character->name }} {{ $character->lastname }}</b>&nbsp;- {{ $nickname }} - {{ $character->created_at->format('d.m.Y') }}
                            <a class="secondary-content" href="{{ route('admin.character.show', $character->id) }}">
